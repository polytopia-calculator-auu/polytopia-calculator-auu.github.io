...
const Toggle = class {
  constructor(hostRef) {
    ...
    this.getSwitchLabelIcon = (mode, checked) => {
      if (mode === 'md') {
        return checked ? _index_40bb69ee_js__WEBPACK_IMPORTED_MODULE_2__.f : _index_40bb69ee_js__WEBPACK_IMPORTED_MODULE_2__.r;
      }

      return checked ? _index_40bb69ee_js__WEBPACK_IMPORTED_MODULE_2__.r : _index_40bb69ee_js__WEBPACK_IMPORTED_MODULE_2__.g;
    };
  }
  ...
  onMove(detail) {
    if (shouldToggle((0,_dir_e8b767a8_js__WEBPACK_IMPORTED_MODULE_6__.i)(this.el), this.checked, detail.deltaX, -10)) {
      this.checked = !this.checked;
      (0,_haptic_683b3b3c_js__WEBPACK_IMPORTED_MODULE_5__.c)();
    }
  }
