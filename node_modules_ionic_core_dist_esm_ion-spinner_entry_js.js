...
const Spinner = class {
  ...
  getName() {
    const spinnerName = this.name || _ionic_global_c95cf239_js__WEBPACK_IMPORTED_MODULE_1__.c.get('spinner');
  ...
  render() {
    ...
    const self = this;
    const mode = (0,_ionic_global_c95cf239_js__WEBPACK_IMPORTED_MODULE_1__.b)(self);
    ...
    return (0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.H, {
      class: (0,_theme_7670341c_js__WEBPACK_IMPORTED_MODULE_2__.c)(self.color, {
        ...
        'spinner-paused': self.paused || _ionic_global_c95cf239_js__WEBPACK_IMPORTED_MODULE_1__.c.getBoolean('_testing')
      }),
      role: "progressbar",
